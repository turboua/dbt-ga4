...
with
    ...
    campaign_level_ads as (
        ...
        left join
            campaign_level
            on agg_ga.campaign = campaign_level.campaign
            and agg_ga.date = campaign_level.date
        where
    ...
    ad_group_level_ads as (
        ...
        left join
            ad_group_level
            on agg_ga.ad_group = ad_group_level.ad_group
            and agg_ga.date = ad_group_level.date
        where
            (agg_ga.source = 'google' or agg_ga.source = 'facebook')
            and agg_ga.medium = 'cpc'
    ...
    ad_ads as (
        ...
        from agg_ga
        left join
            ad_level on agg_ga.ad_id = ad_level.ad_id and agg_ga.date = ad_level.date
        where
            (agg_ga.source = 'google' or agg_ga.source = 'facebook')
            and agg_ga.medium = 'cpc'
            and agg_ga.ad_group is not null
